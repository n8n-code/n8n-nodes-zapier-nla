...
export class ZapierNlaApi implements ICredentialType {
	name = 'N8nDevZapierNlaApi';

	displayName = 'zapier-nla API';

	icon: Icon = { light: 'file:../nodes/ZapierNla/zapier-nla.png', dark: 'file:../nodes/ZapierNla/zapier-nla.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your zapier-nla API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
